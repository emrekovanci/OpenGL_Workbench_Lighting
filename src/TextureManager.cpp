...
void TextureManager::load(const std::string& fileName, const std::string& identifier)
{
    ...
    _textures[identifier] = textureID;
}

unsigned int TextureManager::get(const std::string& identifier)
{
